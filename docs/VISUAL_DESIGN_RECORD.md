...
> **Read with `PLAN.md` phase 4.** Written under an earlier numbering; the
> design decisions stand, the phase references are history. The colour scheme
> here is the owner's and is kept.
